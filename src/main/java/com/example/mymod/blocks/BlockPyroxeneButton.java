...
public class BlockPyroxeneButton extends BlockButton {
    public BlockPyroxeneButton() {
        super(true); // true = wooden button (longer press duration)
        setRegistryName("pyroxene_button");
        setUnlocalizedName(MyMod.MODID + ".pyroxene_button");
