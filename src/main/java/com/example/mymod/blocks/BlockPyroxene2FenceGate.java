...
public class BlockPyroxene2FenceGate extends Block {
    ...
    public BlockPyroxene2FenceGate() {
        super(Material.WOOD);
        setRegistryName("pyroxene2_fence_gate");
        setUnlocalizedName(MyMod.MODID + ".pyroxene2_fence_gate");
