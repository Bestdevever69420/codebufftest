...
public class BlockPyroxene3Button extends BlockButton {
    public BlockPyroxene3Button() {
        super(true);
        setRegistryName("pyroxene3_button");
        setUnlocalizedName(MyMod.MODID + ".pyroxene3_button");
