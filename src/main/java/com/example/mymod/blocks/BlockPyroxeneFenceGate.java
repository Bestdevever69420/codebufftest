...
public class BlockPyroxeneFenceGate extends Block {
    ...
    public BlockPyroxeneFenceGate() {
        super(Material.WOOD);
        setRegistryName("pyroxene_fence_gate");
        setUnlocalizedName(MyMod.MODID + ".pyroxene_fence_gate");
    ...
    public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
        // Could add redstone logic here if needed
    }
