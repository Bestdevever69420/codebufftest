...
public class WorldGenPyroxeneTree extends WorldGenAbstractTree {
    private static final IBlockState LOG = ModBlocks.pyroxene_wood.getDefaultState().withProperty(BlockLog.LOG_AXIS, BlockLog.EnumAxis.Y);
    private static final IBlockState LEAVES = ModBlocks.pyroxene_leaves.getDefaultState();

    public WorldGenPyroxeneTree() {
        super(true);
    }
